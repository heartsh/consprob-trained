...
def main():
  ...
  trained_probcons_plus_consalifold_params = []
  ...
  trained_consalifold_params_4_elapsed_time = []
  ...
  rna_seq_dir_path = asset_dir_path + "/test_data"
  ...
  trained_probcons_plus_consalifold_dir_path = asset_dir_path + "/trained_probcons_plus_consalifold"
  ...
  if not os.path.isdir(trained_probcons_plus_consalifold_dir_path):
    os.mkdir(trained_probcons_plus_consalifold_dir_path)
  ...
  for rna_seq_file in os.listdir(rna_seq_dir_path):
    ...
    trained_probcons_plus_consalifold_output_dir_path = os.path.join(trained_probcons_plus_consalifold_dir_path, rna_family_name)
    ...
    if not os.path.isdir(trained_probcons_plus_consalifold_output_dir_path):
      os.mkdir(trained_probcons_plus_consalifold_output_dir_path)
