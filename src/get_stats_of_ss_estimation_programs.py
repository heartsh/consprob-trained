...
def main():
  ...
  line_1, = pyplot.plot(conshomfold_ppvs, conshomfold_senss, label = "$ConsHomfold^{chimera}$", marker = "circle", linestyle = "solid")
  line_2, = pyplot.plot(conshomfold_ppvs_trained, conshomfold_senss_trained, label = "$ConsHomfold^{train}$", marker = "triangle_down", linestyle = "solid")
  line_3, = pyplot.plot(centroidhomfold_ppvs, centroidhomfold_senss, label = "CentroidHomFold", marker = "square", linestyle = "dashed")
  line_4, = pyplot.plot(rnafold_ppv, rnafold_sens, label = "RNAfold", marker = "star")
  line_5, = pyplot.plot(contrafold_ppvs, contrafold_senss, label = "CONTRAfold", marker = "pentagon", linestyle = "dashdot")
  line_6, = pyplot.plot(centroidfold_ppvs, centroidfold_senss, label = "CentroidFold", marker = "diamond", linestyle = "dotted")
  ...
  pyplot.clf()
  line_1, = pyplot.plot(conshomfold_fprs_trained, conshomfold_senss_trained, label = "$ConsHomfold^{train}$", marker = "circle", linestyle = "solid")
  line_2, = pyplot.plot(conshomfold_fprs, conshomfold_senss, label = "$ConsHomfold^{train}$", marker = "triangle_down", linestyle = "solid")
  line_3, = pyplot.plot(centroidhomfold_fprs, centroidhomfold_senss, label = "CentroidHomfold", marker = "square", linestyle = "dashed")
  line_4, = pyplot.plot(rnafold_fprs, rnafold_senss, label = "RNAfold", marker = "star")
  line_5, = pyplot.plot(contrafold_fprs, contrafold_senss, label = "CONTRAfold", marker = "pentagon", linestyle = "dashdot")
  line_5, = pyplot.plot(centroidfold_fprs, centroidfold_senss, label = "CentroidFold", marker = "diamond", linestyle = "dotted")
  ...
  line_1, = pyplot.plot(gammas, conshomfold_f1_scores_trained, label = "$ConsHomfold^{train}", marker = "circle", linestyle = "solid")
  line_2, = pyplot.plot(gammas, conshomfold_f1_scores, label = "$ConsHomfold^{chimera}$", marker = "triangle_down", linestyle = "solid")
  line_3, = pyplot.plot(gammas, centroidhomfold_f1_scores, label = "CentroidHomfold", marker = "square", linestyle = "dashed")
  line_4, = pyplot.plot(-2, rnafold_f1_score, label = "RNAfold", marker = "star")
  line_5, = pyplot.plot(gammas, contrafold_f1_scores, label = "CONTRAfold", marker = "pentagon", linestyle = "dashdot")
  line_6, = pyplot.plot(gammas, centroidfold_f1_scores, label = "CentroidFold", marker = "diamond", linestyle = "dotted")
  ...
  pyplot.clf()
  line_1, = pyplot.plot(gammas, conshomfold_mccs_trained, label = "$ConsHomfold^{train}$", marker = "circle", linestyle = "solid")
  line_2, = pyplot.plot(gammas, conshomfold_mccs, label = "$ConsHomfold^{chimera}$", marker = "triangle_down", linestyle = "solid")
  line_3, = pyplot.plot(gammas, centroidhomfold_mccs, label = "CentroidHomfold", marker = "square", linestyle = "dashed")
  line_4, = pyplot.plot(-2, rnafold_mcc, label = "RNAfold", marker = "star")
  line_5, = pyplot.plot(gammas, contrafold_mccs, label = "CONTRAfold", marker = "pentagon", linestyle = "dashdot")
  line_6, = pyplot.plot(gammas, centroidfold_mccs, label = "CentroidFold", marker = "diamond", linestyle = "dotted")
  pyplot.xlabel("$\log_2 \gamma$")
  pyplot.ylabel("MCC")
  pyplot.tight_layout()
