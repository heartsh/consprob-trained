...
def main():
  ...
  conshomfold_ppvs_new_transfer_off = []
  conshomfold_senss_new_transfer_off = []
  conshomfold_fprs_new_transfer_off = []
  conshomfold_f1_scores_new_transfer_off = []
  conshomfold_mccs_new_transfer_off = []
  ...
  conshomfold_ss_dir_path_new_transfer_off = asset_dir_path + "/conshomfold_new_transfer_off"
  ...
  for gamma in gammas:
    ...
    conshomfold_count_params_new_transfer_off = []
    ...
    for rna_fam_file in os.listdir(rna_fam_dir_path):
      ...
      conshomfold_estimated_ss_dir_path_new_transfer_off = os.path.join(conshomfold_ss_dir_path_new_transfer_off, rna_fam_name)
      ...
      conshomfold_estimated_ss_file_path_new_transfer_off = os.path.join(conshomfold_estimated_ss_dir_path_new_transfer_off, "gamma=" + gamma_str + ".fa")
      ...
      conshomfold_count_params_new_transfer_off.insert(0, (conshomfold_estimated_ss_file_path_new_transfer_off, ref_sss_and_flat_sss, rna_seq_lens))
    ...
    results = pool.map(get_pos_neg_counts, conshomfold_count_params_new_transfer_off)
    tp, tn, fp, fn = final_sum(results)
    ppv = get_ppv(tp, fp)
    sens = get_sens(tp, fn)
    fpr = get_fpr(tn, fp)
    conshomfold_ppvs_new_transfer_off.insert(0, ppv)
    conshomfold_senss_new_transfer_off.insert(0, sens)
    conshomfold_fprs_new_transfer_off.insert(0, fpr)
    conshomfold_f1_scores_new_transfer_off.append(get_f1_score(ppv, sens))
    conshomfold_mccs_new_transfer_off.append(get_mcc(tp, tn, fp, fn))
  ...
  line_3, = pyplot.plot(conshomfold_ppvs_new_transfer_on, conshomfold_senss_new_transfer_on, label = "ConsHomfold (new, transfer learning on)", marker = "v", linestyle = "--")
  line_4, = pyplot.plot(conshomfold_ppvs_new_transfer_off, conshomfold_senss_new_transfer_off, label = "ConsHomfold (new, transfer learning off)", marker = "d", linestyle = "--")
  ...
  line_3, = pyplot.plot(conshomfold_fprs_new_transfer_on, conshomfold_senss_new_transfer_on, label = "ConsHomfold (new, transfer learning on)", marker = "v", linestyle = "--")
  line_3, = pyplot.plot(conshomfold_fprs_new_transfer_off, conshomfold_senss_new_transfer_off, label = "ConsHomfold (new, transfer learning off)", marker = "d", linestyle = "--")
  ...
  line_3, = pyplot.plot(gammas, conshomfold_f1_scores_new_transfer_on, label = "ConsHomfold (new, transfer learning on)", marker = "v", linestyle = "--")
  line_4, = pyplot.plot(gammas, conshomfold_f1_scores_new_transfer_off, label = "ConsHomfold (new, transfer learning off)", marker = "d", linestyle = "--")
  pyplot.xlabel("$\log_2 \gamma$")
  pyplot.ylabel("F1 score")
  pyplot.legend(handles = [line_1, line_2, line_3, line_4], loc = "lower right")
  pyplot.tight_layout()
  ...
  line_3, = pyplot.plot(gammas, conshomfold_mccs_new_transfer_on, label = "ConsHomfold (new, transfer learning on)", marker = "v", linestyle = "--")
  line_4, = pyplot.plot(gammas, conshomfold_mccs_new_transfer_off, label = "ConsHomfold (new, transfer learning off)", marker = "d", linestyle = "--")
  pyplot.xlabel("$\log_2 \gamma$")
  pyplot.ylabel("MCC")
  pyplot.tight_layout()
