...
def main():
  ...
  trained_probcons_plus_consalifold_ppvs = []
  trained_probcons_plus_consalifold_senss = []
  trained_probcons_plus_consalifold_fprs = []
  trained_probcons_plus_consalifold_f1_scores = []
  trained_probcons_plus_consalifold_mccs = []
  ...
  for gamma in gammas:
    ...
    trained_probcons_plus_consalifold_count_params = []
    ...
    for rna_fam_file in os.listdir(rna_fam_dir_path):
      ...
      trained_probcons_plus_consalifold_estimated_css_file_path = os.path.join(trained_probcons_plus_consalifold_estimated_css_dir_path, "gamma=" + gamma_str + ".sth")
      estimated_css_and_flat_css = utils.get_css_and_flat_css(trained_probcons_plus_consalifold_estimated_css_file_path)
      trained_probcons_plus_consalifold_count_params.insert(0, (rna_seq_lens, estimated_css_and_flat_css, ref_csss_and_flat_csss, sta_len))
    ...
    results = pool.map(get_bin_counts, trained_probcons_plus_consalifold_count_params)
    ppv, sens, fpr, f1_score, mcc, col_ppv, col_sens, col_fpr, col_f1_score, col_mcc, = get_metrics(final_sum(results))
    trained_probcons_plus_consalifold_ppvs.insert(0, ppv)
    trained_probcons_plus_consalifold_senss.insert(0, sens)
    trained_probcons_plus_consalifold_fprs.insert(0, fpr)
    trained_probcons_plus_consalifold_f1_scores.append(f1_score)
    trained_probcons_plus_consalifold_mccs.append(mcc)
  ...
  # Figure for ProbCons.
  line_1, = pyplot.plot(probcons_plus_consalifold_ppvs, probcons_plus_consalifold_senss, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(trained_probcons_plus_consalifold_ppvs, trained_probcons_plus_consalifold_senss, label = "ConsAlifold (new, trained)", marker = "d", linestyle = "-")
  ...
  # Figure for MAFFT.
  pyplot.figure()
  line_1, = pyplot.plot(mafft_plus_consalifold_ppvs, mafft_plus_consalifold_senss, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  # Figure for ClustalW.
  pyplot.figure()
  line_1, = pyplot.plot(clustalw_plus_consalifold_ppvs, clustalw_plus_consalifold_senss, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  pyplot.figure()
  line_1, = pyplot.plot(mafft_xinsi_plus_consalifold_ppvs, mafft_xinsi_plus_consalifold_senss, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  pyplot.figure()
  line_1, = pyplot.plot(ref_sa_plus_consalifold_ppvs, ref_sa_plus_consalifold_senss, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  # Figure for ProbCons.
  pyplot.figure()
  line_1, = pyplot.plot(probcons_plus_consalifold_fprs, probcons_plus_consalifold_senss, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(trained_probcons_plus_consalifold_fprs, trained_probcons_plus_consalifold_senss, label = "ConsAlifold (new, trained)", marker = "d", linestyle = "-")
  ...
  # Figure for MAFFT.
  pyplot.figure()
  line_1, = pyplot.plot(mafft_plus_consalifold_fprs, mafft_plus_consalifold_senss, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  # Figure for ClustalW.
  pyplot.figure()
  line_1, = pyplot.plot(clustalw_plus_consalifold_fprs, clustalw_plus_consalifold_senss, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  # Figure for MAFFT X-INS-i.
  pyplot.figure()
  line_1, = pyplot.plot(mafft_xinsi_plus_consalifold_fprs, mafft_xinsi_plus_consalifold_senss, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  # Figure for reference sequence alignments.
  pyplot.figure()
  line_1, = pyplot.plot(ref_sa_plus_consalifold_fprs, ref_sa_plus_consalifold_senss, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  pyplot.figure()
  line_1, = pyplot.plot(gammas, probcons_plus_consalifold_f1_scores, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(gammas, trained_probcons_plus_consalifold_f1_scores, label = "ConsAlifold (new, trained)", marker = "d", linestyle = "-")
  line_6, = pyplot.plot(min_gamma + numpy.argmax(probcons_plus_consalifold_f1_scores), max(probcons_plus_consalifold_f1_scores), label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[0])
  ...
  line_9, = pyplot.plot(min_gamma + numpy.argmax(trained_probcons_plus_consalifold_f1_scores), max(trained_probcons_plus_consalifold_f1_scores), label = "ConsAlifold (new, trained)", marker = "d", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[4])
  ...
  pyplot.rcParams['legend.fontsize'] = "x-large"
  pyplot.figure()
  line_1, = pyplot.plot(gammas, mafft_plus_consalifold_f1_scores, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(min_gamma + numpy.argmax(mafft_plus_consalifold_f1_scores), max(mafft_plus_consalifold_f1_scores), label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[0])
  ...
  # Figure for ClustalW.
  pyplot.figure()
  line_1, = pyplot.plot(gammas, clustalw_plus_consalifold_f1_scores, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(min_gamma + numpy.argmax(clustalw_plus_consalifold_f1_scores), max(clustalw_plus_consalifold_f1_scores), label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[0])
  ...
  # Figure for MAFFT X-INS-i.
  pyplot.figure()
  line_1, = pyplot.plot(gammas, mafft_xinsi_plus_consalifold_f1_scores, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(min_gamma + numpy.argmax(mafft_xinsi_plus_consalifold_f1_scores), max(mafft_xinsi_plus_consalifold_f1_scores), label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[0])
  ...
  # Figure for reference sequence alignments.
  pyplot.figure()
  line_1, = pyplot.plot(gammas, ref_sa_plus_consalifold_f1_scores, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(min_gamma + numpy.argmax(ref_sa_plus_consalifold_f1_scores), max(ref_sa_plus_consalifold_f1_scores), label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[0])
  ...
  # Figure for ProbCons.
  pyplot.figure()
  line_1, = pyplot.plot(gammas, probcons_plus_consalifold_mccs, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(gammas, trained_probcons_plus_consalifold_mccs, label = "ConsAlifold (new, trained)", marker = "d", linestyle = "-")
  line_6, = pyplot.plot(min_gamma + numpy.argmax(probcons_plus_consalifold_mccs), max(probcons_plus_consalifold_mccs), label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[0])
  ...
  line_9, = pyplot.plot(min_gamma + numpy.argmax(trained_probcons_plus_consalifold_mccs), max(trained_probcons_plus_consalifold_mccs), label = "ConsAlifold (new, trained)", marker = "d", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[4])
  pyplot.xlabel("$\log_2 \gamma$")
  ...
  # Figure for MAFFT.
  pyplot.figure()
  line_1, = pyplot.plot(gammas, mafft_plus_consalifold_mccs, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(min_gamma + numpy.argmax(mafft_plus_consalifold_mccs), max(mafft_plus_consalifold_mccs), label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[0])
  ...
  # Figure for ClustalW.
  pyplot.figure()
  line_1, = pyplot.plot(gammas, clustalw_plus_consalifold_mccs, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(min_gamma + numpy.argmax(clustalw_plus_consalifold_mccs), max(clustalw_plus_consalifold_mccs), label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[0])
  ...
  # Figure for MAFFT X-INS-i.
  pyplot.figure()
  line_1, = pyplot.plot(gammas, mafft_xinsi_plus_consalifold_mccs, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(min_gamma + numpy.argmax(mafft_xinsi_plus_consalifold_mccs), max(mafft_xinsi_plus_consalifold_mccs), label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[0])
  ...
  # Figure for reference sequence alignments.
  pyplot.figure()
  line_1, = pyplot.plot(gammas, ref_sa_plus_consalifold_mccs, label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-")
  ...
  line_5, = pyplot.plot(min_gamma + numpy.argmax(ref_sa_plus_consalifold_mccs), max(ref_sa_plus_consalifold_mccs), label = "ConsAlifold (old, chimera)", marker = "o", linestyle = "-", markerfacecolor = white, markeredgecolor = color_palette[0])
