...
def main():
  ...
  pyplot.tight_layout()
  pyplot.savefig(image_dir_path + "/consalign_sps_corr_bralibase.svg", bbox_inches = "tight")
  pyplot.clf()
  ...
  pyplot.tight_layout()
  pyplot.savefig(image_dir_path + "/consalign_gamma_corr_bralibase.svg", bbox_inches = "tight")
  pyplot.clf()
