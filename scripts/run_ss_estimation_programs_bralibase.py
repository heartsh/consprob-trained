...
def main():
  ...
  consalign_dir_path_disabled_alifold = asset_dir_path + "/consalign_bralibase_disabled_alifold"
  ...
  for rna_sub_dir in os.listdir(rna_dir_path):
    ...
    for rna_file in os.listdir(rna_seq_dir_path):
      ...
      consalign_fin_dir_path_disabled_alifold = os.path.join(consalign_sub_dir_path_disabled_alifold, rna_name)
      ...
      if not os.path.isdir(consalign_fin_dir_path_disabled_alifold):
        os.mkdir(consalign_fin_dir_path_disabled_alifold)
      ...
      consalign_params.insert(0, (rna_file_path, consalign_fin_dir_path, sub_thread_num, "ensemble", "trained_transfer", False))
      consalign_params_disabled_alifold.insert(0, (rna_file_path, consalign_fin_dir_path_disabled_alifold, sub_thread_num, "ensemble", "trained_transfer", True))
      consalign_params_turner.insert(0, (rna_file_path, consalign_fin_dir_path_turner, sub_thread_num, "turner", "trained_transfer", True))
      consalign_params_trained_transfer.insert(0, (rna_file_path, consalign_fin_dir_path_trained_transfer, sub_thread_num, "trained", "trained_transfer", True))
      consalign_params_trained_random_init.insert(0, (rna_file_path, consalign_fin_dir_path_trained_random_init, sub_thread_num, "trained", "trained_random_init", True))
      consalign_params_transferred_only.insert(0, (rna_file_path, consalign_fin_dir_path_transferred_only, sub_thread_num, "trained", "transferred_only", True))
