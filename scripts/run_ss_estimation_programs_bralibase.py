...
def main():
  ...
  turbofold_params = []
  raf_dir_path = asset_dir_path + "/raf_bralibase"
  locarna_dir_path = asset_dir_path + "/locarna_bralibase"
  dafs_dir_path = asset_dir_path + "/dafs_bralibase"
  sparse_dir_path = asset_dir_path + "/sparse_bralibase"
  turbofold_dir_path = asset_dir_path + "/turbofold_bralibase"
  consalign_dir_path = asset_dir_path + "/consalign_bralibase"
  consalign_dir_path_turner = asset_dir_path + "/consalign_bralibase_turner"
  consalign_dir_path_turner_disabled_transplant = asset_dir_path + "/consalign_bralibase_turner_disabled_transplant"
  consalign_dir_path_trained_transfer = asset_dir_path + "/consalign_bralibase_trained_transfer"
  consalign_dir_path_trained_random_init = asset_dir_path + "/consalign_bralibase_trained_random_init"
  consalign_dir_path_transferred_only = asset_dir_path + "/consalign_bralibase_transferred_only"
  consalign_elapsed_time_data_file_path = asset_dir_path + "/consalign_elapsed_time_data_bralibase.dat"
  raf_elapsed_time_data_file_path = asset_dir_path + "/raf_elapsed_time_data_bralibase.dat"
  locarna_elapsed_time_data_file_path = asset_dir_path + "/locarna_elapsed_time_data_bralibase.dat"
  dafs_elapsed_time_data_file_path = asset_dir_path + "/dafs_elapsed_time_data_bralibase.dat"
  sparse_elapsed_time_data_file_path = asset_dir_path + "/sparse_elapsed_time_data_bralibase.dat"
  turbofold_elapsed_time_data_file_path = asset_dir_path + "/turbofold_elapsed_time_data_bralibase.dat"
  ...
  for rna_sub_dir in os.listdir(rna_dir_path):
    ...
    for rna_file in os.listdir(rna_seq_dir_path):
      rna_file_path = os.path.join(rna_seq_dir_path, rna_file)
      if not rna_file_path.endswith(".fa"):
        continue
      (rna_name, extension) = os.path.splitext(rna_file)
      raf_output_file_path = os.path.join(raf_sub_dir_path, rna_name + ".sth")
      locarna_output_file_path = os.path.join(locarna_sub_dir_path, rna_name + ".sth")
      dafs_output_file_path = os.path.join(dafs_sub_dir_path, rna_name + ".sth")
      sparse_output_file_path = os.path.join(sparse_sub_dir_path, rna_name + ".sth")
      ...
      consalign_fin_dir_path = os.path.join(consalign_sub_dir_path, rna_name)
      consalign_fin_dir_path_turner = os.path.join(consalign_sub_dir_path_turner, rna_name)
      consalign_fin_dir_path_turner_disabled_transplant = os.path.join(consalign_sub_dir_path_turner_disabled_transplant, rna_name)
      consalign_fin_dir_path_trained_transfer = os.path.join(consalign_sub_dir_path_trained_transfer, rna_name)
      consalign_fin_dir_path_trained_random_init = os.path.join(consalign_sub_dir_path_trained_random_init, rna_name)
      consalign_fin_dir_path_transferred_only = os.path.join(consalign_sub_dir_path_transferred_only, rna_name)
      turbofold_fin_dir_path = os.path.join(turbofold_sub_dir_path, rna_name)
      if not os.path.isdir(consalign_fin_dir_path):
        os.mkdir(consalign_fin_dir_path)
      if not os.path.isdir(consalign_fin_dir_path_turner):
        os.mkdir(consalign_fin_dir_path_turner)
      if not os.path.isdir(consalign_fin_dir_path_turner_disabled_transplant):
        os.mkdir(consalign_fin_dir_path_turner_disabled_transplant)
      if not os.path.isdir(consalign_fin_dir_path_trained_transfer):
        os.mkdir(consalign_fin_dir_path_trained_transfer)
      if not os.path.isdir(consalign_fin_dir_path_trained_random_init):
        os.mkdir(consalign_fin_dir_path_trained_random_init)
      if not os.path.isdir(consalign_fin_dir_path_transferred_only):
        os.mkdir(consalign_fin_dir_path_transferred_only)
      if not os.path.isdir(turbofold_fin_dir_path):
        os.mkdir(turbofold_fin_dir_path)
      consalign_params.insert(0, (rna_file_path, consalign_fin_dir_path, sub_thread_num, "ensemble", "trained_transfer", False, False))
      consalign_params_turner.insert(0, (rna_file_path, consalign_fin_dir_path_turner, sub_thread_num, "turner", "trained_transfer", True, False))
      consalign_params_turner_disabled_transplant.insert(0, (rna_file_path, consalign_fin_dir_path_turner_disabled_transplant, sub_thread_num, "turner", "trained_transfer", True, True))
      consalign_params_trained_transfer.insert(0, (rna_file_path, consalign_fin_dir_path_trained_transfer, sub_thread_num, "trained", "trained_transfer", True, False))
      consalign_params_trained_random_init.insert(0, (rna_file_path, consalign_fin_dir_path_trained_random_init, sub_thread_num, "trained", "trained_random_init", True, False))
      consalign_params_transferred_only.insert(0, (rna_file_path, consalign_fin_dir_path_transferred_only, sub_thread_num, "trained", "transferred_only", True, False))
      turbofold_params.insert(0, (rna_file_path, turbofold_fin_dir_path))
