...
def main():
  ...
  print("# entries in BRAlibase = %d" % (num_of_range_short + num_of_range_mid + num_of_range_long))
  ...
  pyplot.tight_layout()
  pyplot.savefig(image_dir_path + "/avg_seq_len_dist_bralibase.eps", bbox_inches = "tight")
  pyplot.clf()
  ...
  pyplot.tight_layout()
  pyplot.savefig(image_dir_path + "/rna_aligner_reg_plot_elapsed_time_bralibase.eps", bbox_inches = "tight")
  pyplot.clf()
