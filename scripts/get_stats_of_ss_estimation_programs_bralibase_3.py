...
def main():
  ...
  pyplot.tight_layout()
  pyplot.savefig(image_dir_path + "/avg_seq_len_dist_bralibase.svg", bbox_inches = "tight")
  pyplot.clf()
  ...
  pyplot.tight_layout()
  pyplot.savefig(image_dir_path + "/rna_aligner_reg_plot_elapsed_time_bralibase.svg", bbox_inches = "tight")
  pyplot.clf()
